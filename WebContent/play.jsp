	...
	<div id="right-column">
		...
		<div class="right-block">
			...
			<div class="rb-mid">
				...
				<div class="rb-info">
 <font face="chiller" size="14" color="yellow" align="center">
 <br/>
 <br/>
 <br/>
 <br/>
				Congratulations!! You may play now!! 
				<br/>
				<br/>
				<br/>
				<br/>
...
<div id="footer">
	...
	<div id="footer-mid">
		...
		<div id="ft-left-column">
			...
			<div id="ft-left-title">Zoid Quick Contact Form</div>
		...
		<div id="ft-right-column">
			...
			<div id="ft-right-title">Other Info About Us</div>
